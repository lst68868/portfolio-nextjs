      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <div className="flex space-x-5 pt-6">
            <a href="https://www.github.com/lst68868" target="_blank">
              <svg
            ...
            <a href="https://www.linkedin.com/in/leotulchin" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
            ...
            <a href="mailto:leostulchin@gmail.com" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <p>
            ...
            platform with the power of openAI, AWS Lambdas, and ASP.NET core.
          </p>
          <p>
            With my additional background as a systems administrator and
            strategic consultant to the United States federal Government, I
            bring an expertise in client relations and business management to my
            engineering work.
          </p>
          <p>
